...
@section('title', 'Forgot Password - Football Predictions')
        ...
        <div class="max-w-md w-full" data-aos="fade-up">
            ...
            <form class="space-y-6" method="POST" action="{{ route('password.email') }}">
                ...
                <div class="text-center mt-6">
                    <a href="{{ route('login') }}" class="text-sm font-medium text-slate-500 hover:text-primary-600 transition-colors">
