        ...
        <nav class="bg-white/80 backdrop-blur-md border-b border-slate-200 sticky top-0 z-50" aria-label="Main navigation">
                ...
                <div class="flex justify-between h-20">
                    <div class="flex items-center">
                        ...
                        <div class="hidden lg:ml-12 lg:flex lg:space-x-8">
                            ...
                            <a href="<?php echo e(route('blog.index')); ?>" class="inline-flex items-center px-3 py-2 text-sm font-medium text-slate-700 hover:text-primary-600 transition-colors duration-200">
            ...
            <div class="lg:hidden hidden animate-fade-in-down" id="mobile-menu">
                <div class="px-2 pt-2 pb-3 space-y-1 bg-white border-t border-slate-100 shadow-xl">
                    ...
                    <a href="<?php echo e(route('blog.index')); ?>" class="flex items-center px-4 py-3 rounded-xl text-base font-semibold text-slate-700 hover:text-primary-600 hover:bg-slate-50 transition-colors">
