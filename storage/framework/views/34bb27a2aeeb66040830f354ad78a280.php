...
<?php $__env->startSection('title', 'Sure Tips Prediction - ' . $category . ' Winning Tips for Today'); ?>
<?php $__env->startSection('meta_description', 'Get the best ' . $category . ' sure tips prediction and winning tips for today. Our accurate football prediction models cover all major leagues.'); ?>
<?php $__env->startSection('meta_keywords', $category . ' predictions, winning tips for today, sure tips prediction, best betting tip'); ?>
...
<div class="bg-slate-50 min-h-screen pb-20">
    ...
    <section class="relative bg-slate-900 pt-32 pb-32 overflow-hidden">
        ...
        <div class="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center" data-aos="zoom-out">
            ...
            <h1 class="text-4xl lg:text-6xl font-black text-white mb-6"><?php echo e($category); ?> Sure Tips Prediction</h1>
            <p class="text-xl text-slate-400 max-w-2xl mx-auto leading-relaxed">
                Expert insights and mathematical models tailored specifically for the <?php echo e($category); ?> betting market.
            </p>
        </div>
    </section>
    ...
    <div class="sticky top-20 z-40 bg-white/80 backdrop-blur-xl border-b border-slate-200">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex items-center space-x-1 overflow-x-auto py-4 no-scrollbar">
                <a href="<?php echo e(route('predictions')); ?>" class="px-5 py-2.5 rounded-2xl text-sm font-bold transition-all text-slate-500 hover:bg-slate-50 whitespace-nowrap">
                    All Markets
                </a>
                ...
                <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <a href="<?php echo e(route($cat['route'])); ?>" class="px-5 py-2.5 rounded-2xl text-sm font-bold transition-all whitespace-nowrap <?php echo e($category == $cat['val'] ? 'bg-primary-600 text-white shadow-lg shadow-primary-600/20' : 'text-slate-600 hover:bg-slate-50'); ?>">
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mt-16">
            ...
            <div class="mb-12" data-aos="fade-up">
                <div class="flex items-center space-x-4 mb-8">
                    <div class="w-10 h-10 bg-white rounded-2xl shadow-sm border border-slate-100 flex items-center justify-center">
                        <img src="<?php echo e($fixtures[0]->league_logo); ?>" class="w-6 h-6 object-contain opacity-80">
                    </div>
                    <div>
                        <span class="text-[10px] font-black text-blue-600 uppercase tracking-widest"><?php echo e($fixtures[0]->league_country); ?></span>
                        <h2 class="text-xl font-black text-slate-900 leading-tight"><?php echo e($leagueName); ?></h2>
                    </div>
                </div>
                ...
                <div class="bg-white rounded-[2.5rem] shadow-sm border border-slate-100 overflow-hidden">
                    ...
                    <?php $__currentLoopData = $fixtures; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $fixture): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        ...
                        <tr class="hover:bg-slate-50 transition-colors cursor-pointer" onclick="window.location='<?php echo e(route('match.detail', $fixture->id)); ?>'">
                            <td class="px-6 py-4" data-label="Time"><span class="font-bold text-slate-900"><?php echo e($fixture->match_date->format('H:i')); ?></span></td>
                            ...
                            <td class="px-6 py-4" data-label="Tip"><span class="px-3 py-1.5 bg-blue-50 text-blue-700 rounded-xl text-sm font-bold"><?php echo e($tip); ?></span></td>
                            <td class="px-6 py-4" data-label="Conf"><span class="font-bold text-blue-600"><?php echo e($prediction->confidence); ?>%</span></td>
                            <td class="px-6 py-4 text-right pr-6" data-label="Odds"><span class="font-black text-slate-900"><?php echo e($prediction->odds ?? '-'); ?></span></td>
                        </tr>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </tbody>
        ...
        <?php else: ?>
            ...
            <div class="bg-white rounded-[4rem] p-24 text-center shadow-2xl border border-slate-100 max-w-4xl mx-auto">
                ...
                <h3 class="text-3xl font-black text-slate-900 mb-4">No <?php echo e($category); ?> Tips Yet</h3>
                <p class="text-slate-500 text-lg mb-10">Our analysts are scouring the markets for the best <?php echo e($category); ?> value today. New selections appear here as soon as they're confirmed.</p>
                <div class="flex flex-col sm:flex-row gap-4 justify-center">
                     <a href="<?php echo e(route('predictions')); ?>" class="px-8 py-4 bg-slate-900 text-white font-bold rounded-2xl hover:bg-slate-800 transition-all">
                        View All Markets
                     </a>
                     <a href="<?php echo e(route('home')); ?>" class="px-8 py-4 bg-white border border-slate-200 text-slate-600 font-bold rounded-2xl hover:bg-slate-50 transition-all">
                        Homepage
                     </a>
                </div>
            </div>
    ...
    <section class="mt-32 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="bg-gradient-to-br from-blue-600 to-blue-800 rounded-[3.5rem] p-12 lg:p-20 text-white text-center shadow-2xl shadow-blue-500/30 overflow-hidden relative">
            ...
            <div class="relative z-10" data-aos="fade-up">
                <h2 class="text-3xl lg:text-5xl font-black mb-6">Master the <?php echo e($category); ?> Market</h2>
                <p class="text-xl text-blue-100 mb-12 max-w-2xl mx-auto">Unlock access to our high-margin algorithm that predicts <?php echo e($category); ?> outcomes with up to 95% accuracy.</p>
                <div class="flex flex-col sm:flex-row gap-6 justify-center">
                    <a href="<?php echo e(route('predictions.premium')); ?>" class="bg-white text-blue-600 px-10 py-5 rounded-2xl font-black text-lg hover:shadow-xl hover:-translate-y-1 transition-all">
                        <i class="fas fa-crown mr-3"></i> Get VIP Tips
                    </a>
                    <a href="<?php echo e(route('pricing')); ?>" class="bg-blue-500/50 backdrop-blur-md text-white border border-white/20 px-10 py-5 rounded-2xl font-black text-lg hover:bg-blue-500 transition-all">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/simeonuba/Downloads/public_html (1)/resources/views/predictions/category.blade.php ENDPATH**/ ?>