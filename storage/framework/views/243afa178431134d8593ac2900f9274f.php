...
<?php $__env->startSection('title', 'Payment Details - Football Predictions'); ?>
...
<div class="bg-slate-950 min-h-screen pb-20">
    ...
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 -mt-10 relative z-10">
        ...
        <div class="bg-red-500/10 border border-red-500/20 text-red-400 px-6 py-4 rounded-2xl mb-8 flex items-center gap-4" role="alert">
            ...
            <span class="text-sm font-black uppercase tracking-widest"><?php echo e(session('error')); ?></span>
        </div>
        <?php endif; ?>
                ...
                <div class="flex-1 w-full">
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-8">
                        <div>
                            ...
                            <h3 class="text-xl font-black text-white leading-tight"><?php echo e($pricingPlan->name); ?></h3>
                            <p class="text-sm font-bold text-slate-400 mt-1"><?php echo e($pricingPlan->duration_days); ?> Days Unlimited Access</p>
                        </div>
                        <div class="bg-slate-800/50 rounded-2xl p-6 border border-white/5">
                            ...
                            <div class="flex items-baseline gap-1.5">
                                <span class="text-lg font-bold text-yellow-500"><?php echo e($currency); ?></span>
                                <span class="text-4xl font-black text-white tracking-tighter"><?php echo e(number_format($amount)); ?></span>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="bg-slate-900/50 backdrop-blur-xl rounded-[2.5rem] p-8 border border-white/10 mb-8 shadow-2xl" data-aos="fade-up" data-aos-delay="100">
            <div class="flex items-center mb-10 pb-6 border-b border-white/5">
                <div class="w-14 h-14 bg-<?php echo e($paymentMethod->color); ?>-500/10 rounded-2xl flex items-center justify-center mr-5 border border-<?php echo e($paymentMethod->color); ?>-500/20">
                    <i class="<?php echo e($paymentMethod->icon); ?> text-<?php echo e($paymentMethod->color); ?>-500 text-2xl"></i>
                </div>
                <div>
                    <h2 class="text-2xl font-black text-white uppercase tracking-tight"><?php echo e($paymentMethod->display_name); ?></h2>
                    <p class="text-sm font-bold text-slate-500 uppercase tracking-widest"><?php echo e($paymentMethod->type === 'crypto' ? 'Blockchain Payment' : 'Secure Gateway'); ?></p>
                </div>
            </div>

            <?php if($paymentMethod->type === 'crypto'): ?>
                <!-- Cryptocurrency Payment Details -->
                <div class="space-y-8">
                    <?php if($paymentMethod->config && isset($paymentMethod->config['address'])): ?>
                    <div>
                        <label class="block text-[10px] font-black text-slate-500 uppercase tracking-[0.2em] mb-3">Send <?php echo e($paymentMethod->crypto_type); ?> to this address</label>
                        <div class="flex flex-col sm:flex-row items-stretch gap-3">
                            <div class="relative flex-1">
                                <input type="text" 
                                       value="<?php echo e($paymentMethod->config['address']); ?>" 
                                       readonly 
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-6">
                        <?php if($paymentMethod->config && isset($paymentMethod->config['network'])): ?>
                        <div class="bg-white/5 rounded-2xl p-5 border border-white/5">
                            ...
                            <span class="text-white font-black uppercase tracking-tight">
                                <?php echo e(strtoupper($paymentMethod->config['network'])); ?>
                        ...
                        <div class="bg-white/5 rounded-2xl p-5 border border-white/5">
                            ...
                            <span class="text-white font-black uppercase tracking-tight"><?php echo e($paymentMethod->crypto_type); ?></span>
                        </div>
                    </div>
                        ...
                        <div class="flex gap-4">
                            ...
                            <div>
                                ...
                                <ul class="text-xs text-slate-400 space-y-2">
                                    <li class="flex items-start gap-2">• <span class="bg-yellow-500/10 text-yellow-500 px-1 font-bold">Important:</span> Only send through the <?php echo e(strtoupper($paymentMethod->config['network'] ?? 'N/A')); ?> network. Assets sent via other networks will be lost.</li>
                                    <li>• Send the exact equivalent of <?php echo e($currency); ?> <?php echo e(number_format($amount)); ?> at current rates.</li>
            ...
            <?php elseif($paymentMethod->type === 'flutterwave'): ?>
            ...
            <?php elseif($paymentMethod->type === 'paypal'): ?>
            ...
            <?php elseif($paymentMethod->type === 'skrill'): ?>
            ...
            <?php elseif($paymentMethod->type === 'bank_transfer'): ?>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                            <div class="space-y-6">
                                <div>
                                    ...
                                    <h4 class="text-xl font-black text-white uppercase tracking-tight"><?php echo e($paymentMethod->config['bank_name'] ?? 'N/A'); ?></h4>
                                </div>
                                <div>
                                    <p class="text-[10px] font-black text-slate-500 uppercase tracking-widest mb-2">Account Identity</p>
                                    <h4 class="text-xl font-black text-white uppercase tracking-tight"><?php echo e($paymentMethod->config['account_name'] ?? 'N/A'); ?></h4>
                                </div>
                            </div>
                            ...
                            <div class="bg-slate-950/50 rounded-2xl p-6 border border-white/5 flex flex-col justify-center">
                                ...
                                <div class="flex items-center gap-3">
                                    <input type="text" 
                                           value="<?php echo e($paymentMethod->config['account_number'] ?? 'N/A'); ?>" 
                                           readonly 
                    ...
                    <div class="bg-blue-500/5 border border-blue-500/10 rounded-3xl p-6">
                        <div class="flex gap-4">
                            ...
                            <div>
                                ...
                                <p class="text-xs text-slate-400 leading-relaxed">
                                    <?php echo e($paymentMethod->config['instructions'] ?? 'Transfer the exact amount and save your receipt for verification.'); ?>
        ...
        <div class="mt-12 text-center">
            <a href="<?php echo e(route('payment.methods', ['plan' => $plan, 'amount' => $amount, 'currency' => $currency])); ?>" 
...
<form id="paymentForm" action="<?php echo e(route('payment.initialize')); ?>" method="POST" style="display: none;">
    <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/simeonuba/Downloads/public_html (1)/resources/views/payment/details.blade.php ENDPATH**/ ?>