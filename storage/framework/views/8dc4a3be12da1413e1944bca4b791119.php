<?php $__env->startSection('title', 'Best Football Prediction Website - Winning Tips for Today'); ?>
<?php $__env->startSection('meta_description', 'Esurebet is the best football prediction website offering sure tips prediction and accurate football prediction for today and tomorrow. Get your bet tips now!'); ?>
        ...
        <div class="grid lg:grid-cols-2 gap-16 items-center">
            <div data-aos="fade-right">
                ...
                <div class="flex flex-col sm:flex-row gap-5">
                    <a href="<?php echo e(route('predictions')); ?>" class="inline-flex items-center justify-center px-8 py-4 text-lg font-bold text-white bg-gradient-to-r from-primary-500 to-primary-600 rounded-2xl hover:from-primary-600 hover:to-primary-700 transition-all duration-300 shadow-lg shadow-primary-500/25 transform hover:-translate-y-1">
                        <i class="fas fa-chart-line mr-3"></i> View Today's Tips
                    </a>
                    <a href="<?php echo e(route('pricing')); ?>" class="inline-flex items-center justify-center px-8 py-4 text-lg font-bold text-white bg-slate-800 border border-slate-700 rounded-2xl hover:bg-slate-700 transition-all duration-300 transform hover:-translate-y-1">
                ...
                <div class="mt-12 flex items-center space-x-8">
                    <!-- <div class="flex -space-x-3">
                        <?php for($i = 1; $i <= 5; $i++): ?>
                            <img class="w-10 h-10 rounded-full border-2 border-slate-900 bg-slate-800" src="https://ui-avatars.com/api/?name=User+<?php echo e($i); ?>&background=random" alt="User <?php echo e($i); ?>">
                        <?php endfor; ?>
                    ...
                    <!-- <div class="text-slate-400 text-sm">
                        <div class="flex items-center text-yellow-400 mb-0.5">
                            <?php for($i = 0; $i < 5; $i++): ?> <i class="fas fa-star text-xs"></i> <?php endfor; ?>
                        </div>
...
<section class="py-24 bg-white">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="text-center mb-16" data-aos="fade-up">
            ...
            <h3 class="text-4xl lg:text-5xl font-extrabold text-slate-900 mb-4 tracking-tight">Football Predictions & Tips for Today, <?php echo e(now()->format('F jS, Y')); ?></h3>
        ...
        <?php if($todayTipsByLeague->count() > 0): ?>
            <div class="space-y-12">
                <?php $__currentLoopData = $todayTipsByLeague; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $leagueName => $fixtures): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="bg-slate-50 rounded-[2.5rem] p-1 border border-slate-100 overflow-hidden" data-aos="fade-up">
                    <div class="p-6 md:px-10 flex items-center space-x-4 border-b border-slate-200/50">
                        <div class="w-12 h-12 bg-white rounded-2xl flex items-center justify-center shadow-sm">
                            <img src="<?php echo e($fixtures[0]['league_logo']); ?>" alt="<?php echo e($leagueName); ?>" class="w-8 h-8 object-contain opacity-80">
                        </div>
                        <div>
                            <span class="text-[10px] font-black text-primary-600 uppercase tracking-widest"><?php echo e($fixtures[0]['league_country']); ?></span>
                            <h4 class="text-xl font-black text-slate-900"><?php echo e($leagueName); ?></h4>
                        </div>
                    </div>
                        ...
                        <table class="w-full text-left responsive-table">
                            ...
                            <tbody class="divide-y divide-slate-200/50">
                                <?php $__currentLoopData = $fixtures; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $fixture): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    ...
                                    ?>
                                    <tr class="hover:bg-white transition-colors group cursor-pointer" onclick="window.location='<?php echo e(route('match.detail', $fixture->id)); ?>'">
                                        <td class="px-6 py-4 border-l-4 border-transparent group-hover:border-primary-500 transition-all" data-label="Time">
                                            <span class="font-bold text-slate-900 block"><?php echo e($fixture->match_date->format('H:i')); ?></span>
                                            <?php if($sLabel): ?>
                                                <span class="text-[9px] font-bold <?php echo e($sClass); ?> px-1.5 py-0.5 rounded"><?php echo e($sLabel); ?></span>
                                            <?php endif; ?>
                                        </td>
                                        <td class="px-6 py-4" data-label="Match">
                                            <div class="flex items-center gap-2">
                                                <img src="<?php echo e($fixture->home_team_logo); ?>" class="w-5 h-5 object-contain">
                                                <span class="text-sm font-bold text-slate-800 max-w-[100px] truncate"><?php echo e($fixture->home_team); ?></span>
                                                <span class="text-[10px] text-slate-300">vs</span>
                                                <span class="text-sm font-bold text-slate-800 max-w-[100px] truncate"><?php echo e($fixture->away_team); ?></span>
                                        ...
                                        <td class="px-6 py-4 text-center" data-label="Score">
                                            <?php if(in_array($fixture->status, ['FT', 'AET', 'PEN'])): ?>
                                                ...
                                                <span class="inline-flex items-center px-3 py-1.5 rounded-xl font-black text-base <?php echo e($scoreWon ? 'bg-green-600 text-white' : 'bg-slate-900 text-white'); ?>">
                                                    <?php echo e($fixture->home_goals); ?> <span class="mx-0.5 text-xs opacity-60">–</span> <?php echo e($fixture->away_goals); ?>

                                                </span>
                                            <?php elseif(in_array($fixture->status, ['LIVE','1H','HT','2H'])): ?>
                                                <span class="inline-flex flex-col items-center px-3 py-1.5 bg-red-500 text-white rounded-xl font-black">
                                                    <span class="flex items-center gap-1">
                                                        <?php echo e($fixture->home_goals ?? 0); ?> <span class="text-red-200 text-xs">–</span> <?php echo e($fixture->away_goals ?? 0); ?>

                                                    </span>
                                                    <span class="text-[9px] text-red-100 font-medium"><?php echo e($fixture->elapsed ? $fixture->elapsed . "'" : 'LIVE'); ?></span>
                                                </span>
                                            <?php else: ?>
                                        ...
                                        <td class="px-6 py-4" data-label="Tip">
                                            <span class="px-3 py-1.5 rounded-lg bg-white border border-slate-200 text-slate-900 font-extrabold text-sm shadow-sm group-hover:border-primary-500 group-hover:text-primary-600 transition-colors">
                                                <?php echo e($prediction->tip); ?>

                                            </span>
                                        </td>
                                        <td class="px-6 py-6 text-right pr-10" data-label="Odds">
                                            <span class="text-lg font-black text-slate-900"><?php echo e($prediction->odds ?? '-'); ?></span>
                                        </td>
                                    </tr>
            ...
            <div class="relative bg-slate-900 rounded-[2.5rem] overflow-hidden">
                ...
                <div class="px-8 py-12 md:p-16 flex flex-col md:flex-row items-center justify-between gap-12">
                    ...
                    <div class="flex-shrink-0" data-aos="zoom-in">
                        <a href="<?php echo e(route('pricing')); ?>" class="group/btn relative inline-flex items-center justify-center px-12 py-6 text-xl font-black text-white bg-emerald-600 rounded-2xl transition-all duration-300 hover:shadow-[0_0_40px_rgba(16,185,129,0.4)] hover:-translate-y-1 overflow-hidden">
...
<section class="py-24 bg-slate-50 relative overflow-hidden">
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex flex-col md:flex-row md:items-end justify-between mb-12" data-aos="fade-up">
            ...
            <a href="<?php echo e(route('predictions')); ?>" class="mt-6 md:mt-0 inline-flex items-center text-primary-600 font-bold hover:text-primary-700 transition-colors">
            ...
            <div class="overflow-x-auto">
                <table class="w-full text-left responsive-table-green">
                    ...
                    <tbody class="divide-y divide-slate-100">
                        <?php $__empty_1 = true; $__currentLoopData = $surePicksTips; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tip): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <?php $pred = $tip->predictions->first(); ?>
                        <tr class="hover:bg-green-50/30 transition-colors cursor-pointer" onclick="window.location='<?php echo e(route('match.detail', $tip->id)); ?>'">
                            <td class="px-6 py-4" data-label="Time">
                                <span class="font-bold text-slate-900"><?php echo e($tip->match_date->format('H:i')); ?></span>
                            </td>
                            <td class="px-6 py-4" data-label="Match">
                                <div class="flex items-center gap-2">
                                    <img src="<?php echo e($tip->home_team_logo); ?>" class="w-5 h-5 object-contain">
                                    <span class="text-sm font-bold text-slate-800"><?php echo e($tip->home_team); ?></span>
                                    <span class="text-[10px] text-slate-300">vs</span>
                                    <span class="text-sm font-bold text-slate-800"><?php echo e($tip->away_team); ?></span>
                                    <img src="<?php echo e($tip->away_team_logo); ?>" class="w-5 h-5 object-contain">
                                </div>
                            </td>
                            <td class="px-6 py-4 text-center" data-label="Score">
                                <?php if(in_array($tip->status, ['FT','AET','PEN'])): ?>
                                    <?php $spPred = $tip->predictions->first(); $scoreWon = $spPred && $spPred->status === 'won'; ?>
                                    <span class="font-black px-3 py-1.5 rounded-lg <?php echo e($scoreWon ? 'bg-green-600 text-white' : 'bg-slate-900 text-white'); ?>"><?php echo e($tip->home_goals); ?> – <?php echo e($tip->away_goals); ?></span>
                                <?php else: ?>
                            ...
                            <td class="px-6 py-4 text-center" data-label="Confidence">
                                                <span class="font-bold text-green-600" style="color:#000 !important"><?php echo e($pred->confidence ?? '-'); ?>%</span>
                            </td>
                            <td class="px-6 py-4 text-right pr-6" data-label="Odds">
                                <span class="font-black text-slate-900"><?php echo e($pred->odds ?? '-'); ?></span>
                            </td>
                        </tr>
...
<section class="py-12 bg-slate-900 border-y border-white/5 overflow-hidden">
    ...
    <div class="relative group">
        <div class="flex space-x-4 overflow-x-auto pb-6 px-4 no-scrollbar">
            <?php $__currentLoopData = array_merge($vipResults->all(), $vvipResults->all()); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $result): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <div class="min-w-[140px] bg-slate-800/50 backdrop-blur-sm border border-white/5 rounded-2xl p-4 text-center group/card transition-all duration-300 hover:bg-slate-800 hover:border-white/10">
                <div class="text-[10px] font-bold text-slate-500 mb-2"><?php echo e($result->date->format('d M')); ?></div>
                <div class="text-lg font-black text-white mb-2"><?php echo e($result->odds); ?><span class="text-xs text-slate-500 ml-0.5">Odds</span></div>
                <div class="flex justify-center">
                    <div class="w-8 h-8 rounded-full <?php echo e($result->status === 'win' ? 'bg-primary-500/20 text-primary-500' : 'bg-red-500/20 text-red-500'); ?> flex items-center justify-center shadow-lg <?php echo e($result->status === 'win' ? 'shadow-primary-500/20' : 'shadow-red-500/20'); ?>">
...
<?php if($featuredByLeague->count() > 0): ?>
<section class="py-24 bg-slate-50">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="space-y-10">
            <?php $__currentLoopData = $featuredByLeague; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $leagueName => $fixtures): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <div data-aos="fade-up">
                <div class="flex items-center space-x-3 mb-4">
                    <span class="w-1.5 h-6 bg-primary-500 rounded-full"></span>
                    <h4 class="text-xl font-black text-slate-900"><?php echo e($leagueName); ?>

                        <span class="ml-3 text-[10px] font-black text-slate-400 border border-slate-200 px-2 py-0.5 rounded-md uppercase tracking-widest"><?php echo e($fixtures[0]['league_country']); ?></span>
                    </h4>
                </div>
...
<section class="py-24 bg-gradient-to-br from-orange-50 to-red-50">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex flex-col md:flex-row md:items-end justify-between mb-12" data-aos="fade-up">
            ...
            <a href="<?php echo e(route('basketball')); ?>" class="mt-6 md:mt-0 inline-flex items-center text-orange-600 font-bold hover:text-orange-700 transition-colors">
                View All Basketball <i class="fas fa-arrow-right ml-2"></i>
            </a>
        </div>
        
        <?php if(isset($basketballTips) && $basketballTips->count() > 0): ?>
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            <?php $__currentLoopData = $basketballTips->take(3); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tip): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <div class="bg-white rounded-2xl shadow-lg border border-orange-200 overflow-hidden hover:shadow-xl transition-all duration-300" data-aos="fade-up">
                <div class="bg-gradient-to-r from-orange-500 to-red-500 px-5 py-3 flex items-center justify-between">
                    <span class="text-white text-xs font-bold"><?php echo e($tip->league_name); ?></span>
                    <span class="text-orange-100 text-xs"><?php echo e($tip->match_date->format('M d, H:i')); ?></span>
                </div>
                <div class="p-5">
                    <div class="flex items-center justify-between mb-3">
                        <div class="text-center flex-1">
                            <span class="font-bold text-slate-800 text-sm block"><?php echo e($tip->home_team); ?></span>
                        </div>
                        <span class="text-lg font-black text-slate-300 mx-3">VS</span>
                        <div class="text-center flex-1">
                            <span class="font-bold text-slate-800 text-sm block"><?php echo e($tip->away_team); ?></span>
                        </div>
                    </div>
                    <?php if($tip->predictions->isNotEmpty()): ?>
                        <?php $pred = $tip->predictions->first(); ?>
                        <div class="bg-orange-50 rounded-xl p-3 mt-3">
                            <div class="flex justify-between text-sm">
                                <span class="text-slate-600">Pick:</span>
                                <span class="font-bold text-orange-700"><?php echo e($pred->tip); ?></span>
                            </div>
                            <div class="flex justify-between text-sm mt-1">
                                <span class="text-slate-600">Confidence:</span>
                                <span class="font-bold text-green-600"><?php echo e($pred->confidence); ?>%</span>
                            </div>
                        </div>
                    <?php endif; ?>
                </div>
...
<section class="py-24 bg-white relative overflow-hidden">
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex flex-col md:flex-row md:items-end justify-between mb-12" data-aos="fade-up">
            ...
            <a href="<?php echo e(route('blog.category', 'soccer')); ?>" class="mt-6 md:mt-0 inline-flex items-center gap-2 px-6 py-3 bg-primary-600 text-white rounded-2xl font-bold text-sm hover:bg-primary-700 transition-all shadow-lg hover:shadow-primary-600/20 group">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <a href="<?php echo e(route('blog.show', $post->slug)); ?>" class="group bg-white rounded-[2rem] border border-slate-100 overflow-hidden hover:shadow-xl hover:border-primary-500/30 transition-all duration-300" data-aos="fade-up">
                ...
                <div class="p-6">
                    ...
                    <h4 class="text-base font-black text-slate-900 group-hover:text-primary-600 transition-colors leading-snug line-clamp-2 mb-2"><?php echo e($post->title); ?></h4>
                    <p class="text-sm text-slate-500 line-clamp-2 leading-relaxed"><?php echo e($post->excerpt); ?></p>
                    <div class="mt-4 pt-4 border-t border-slate-100 flex items-center justify-between">
                        <span class="text-xs font-bold text-slate-400"><?php echo e($post->author); ?></span>
            ...
            <div class="relative grid md:grid-cols-2 gap-12 items-center">
                <div data-aos="fade-up">
                    ...
                    <div class="flex flex-col sm:flex-row gap-4">
                        <a href="<?php echo e(route('register')); ?>" class="inline-flex items-center justify-center px-10 py-5 text-lg font-bold text-white bg-gradient-to-r from-primary-500 to-primary-600 rounded-2xl hover:from-primary-600 hover:to-primary-700 transition-all duration-300 shadow-xl shadow-primary-500/20">
                            Create Account
                        </a>
                        <a href="<?php echo e(route('pricing')); ?>" class="inline-flex items-center justify-center px-10 py-5 text-lg font-bold text-white border-2 border-white/10 rounded-2xl hover:bg-white/5 transition-all duration-300">
                            Pricing Plans
                        </a>
                    </div>
                </div>
        ...
        <div class="grid lg:grid-cols-3 gap-12">
            ...
            <div class="space-y-8">
                ...
                <div class="bg-primary-600 p-8 rounded-3xl text-white shadow-lg shadow-primary-500/20">
                    ...
                    <a href="<?php echo e(route('register')); ?>" class="inline-flex items-center text-white font-black text-sm uppercase tracking-widest group">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/simeonuba/Downloads/public_html (1)/resources/views/home.blade.php ENDPATH**/ ?>