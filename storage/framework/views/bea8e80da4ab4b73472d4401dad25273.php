<?php $__env->startSection('title', 'Dashboard - Football Predictions'); ?>
            ...
            <div class="flex flex-col lg:flex-row items-center justify-between gap-8">
                <div class="text-center lg:text-left" data-aos="fade-right">
                    ...
                    <h1 class="text-4xl lg:text-6xl font-black text-white mb-4 tracking-tight">
                        Welcome, <span class="bg-gradient-to-r from-blue-400 via-blue-500 to-blue-600 bg-clip-text text-transparent italic"><?php echo e(explode(' ', $user->name)[0]); ?>!</span>
                    </h1>
                ...
                <div class="flex flex-col items-center lg:items-end gap-4" data-aos="fade-left">
                    ...
                    <?php elseif($vipStatus['is_active']): ?>
                        <div class="group relative">
                        ...
                        <div class="group relative">
                            ...
                            <div class="relative flex items-center px-8 py-4 bg-slate-900/80 border border-white/10 rounded-2xl backdrop-blur-xl">
                                ...
                                <div>
                                    ...
                                    <a href="<?php echo e(route('pricing')); ?>" class="text-white font-black text-lg hover:text-blue-400 transition-colors tracking-tight underline cursor-pointer">Upgrade Now</a>
                                </div>
                            </div>
                        </div>
                    <?php endif; ?>
                ...
                <div class="relative bg-slate-900/50 backdrop-blur-xl rounded-3xl p-6 border border-white/5 group-hover:border-indigo-500/30 transition-all h-full">
                    <div class="flex items-center gap-4">
                        ...
                        <div>
                            ...
                            <p class="text-2xl font-black text-white tracking-tighter uppercase whitespace-nowrap"><?php echo e($user->created_at->format('M Y')); ?></p>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="p-8">
                            ...
                            <div class="relative bg-slate-800/50 border border-purple-500/20 rounded-[2rem] p-8">
                                <div class="flex flex-col md:flex-row items-center gap-8 mb-8">
                                    ...
                                    <div class="bg-slate-950/50 px-6 py-3 rounded-2xl border border-white/5 text-center">
                                        ...
                                        <p class="text-white font-black"><?php echo e($vvipStatus['expires_at']->format('M d, Y')); ?></p>
                                    </div>
                                </div>
                                ...
                                <div class="space-y-4">
                                    <div class="flex justify-between items-end">
                                        ...
                                        <p class="text-lg font-black text-purple-400 tracking-tighter"><?php echo e($vvipStatus['days_remaining']); ?> Days Left</p>
                                    </div>
                    ...
                    <?php elseif($vipStatus['is_active']): ?>
                        ...
                        <div class="relative group mb-8">
                            ...
                            <div class="relative bg-slate-800/50 border border-blue-500/20 rounded-[2rem] p-8">
                                <div class="flex flex-col md:flex-row items-center gap-8 mb-8">
                                    ...
                                    <div class="bg-slate-950/50 px-6 py-3 rounded-2xl border border-white/5 text-center">
                                        <p class="text-[10px] font-black text-slate-500 uppercase tracking-widest mb-1">Renewal Date</p>
                                        <p class="text-white font-black"><?php echo e($vipStatus['expires_at']->format('M d, Y')); ?></p>
                                    </div>
                                </div>
                                ...
                                <div class="space-y-4">
                                    <div class="flex justify-between items-end">
                                        <p class="text-xs font-black text-slate-400 uppercase tracking-widest">Subscription Life</p>
                                        <p class="text-lg font-black text-blue-400 tracking-tighter"><?php echo e($vipStatus['days_remaining']); ?> Days Left</p>
                                    </div>
                                    <div class="w-full bg-slate-950 rounded-full h-4 p-1 border border-white/5">
                                        <div class="bg-gradient-to-r from-blue-600 via-blue-500 to-cyan-500 h-2 rounded-full shadow-lg shadow-blue-500/20 transition-all duration-1000" 
                                             style="width: <?php echo e($vipStatus['days_remaining'] > 0 ? min(100, ($vipStatus['days_remaining'] / 30) * 100) : 0); ?>%"></div>
                                    </div>
                                </div>

                                <a href="<?php echo e(route('tips.vip')); ?>" class="mt-6 w-full inline-flex items-center justify-center gap-3 px-8 py-5 bg-gradient-to-r from-blue-600 to-cyan-600 text-white rounded-2xl hover:from-blue-500 hover:to-cyan-500 transition-all font-black text-sm uppercase tracking-widest shadow-xl hover:shadow-blue-500/30 group">
                        ...
                        <div class="relative overflow-hidden bg-gradient-to-r from-purple-600 to-indigo-700 rounded-3xl p-8 group">
                            ...
                            <div class="relative z-10">
                                ...
                                <a href="<?php echo e(route('pricing')); ?>" class="inline-flex items-center px-8 py-4 bg-white text-slate-950 rounded-2xl hover:bg-slate-100 transition-all font-black text-xs uppercase tracking-widest shadow-xl">
                    ...
                    <?php else: ?>
                        ...
                        <div class="text-center py-10">
                            ...
                            <a href="<?php echo e(route('pricing')); ?>" class="inline-flex items-center px-10 py-5 bg-gradient-to-r from-blue-500 to-blue-600 text-white rounded-[2rem] hover:shadow-2xl hover:shadow-blue-500/40 transition-all font-black text-xs uppercase tracking-widest">
            ...
            <div class="bg-slate-900/50 backdrop-blur-xl rounded-[2.5rem] border border-white/5 overflow-hidden" data-aos="fade-up" data-aos-delay="200">
                ...
                <div class="p-8">
                    <div class="grid grid-cols-2 lg:grid-cols-3 gap-4 md:gap-6">
                        <!-- VIP Signals -->
                        <a href="<?php echo e(route('tips.vip')); ?>" class="group relative bg-slate-800/50 border border-white/5 rounded-[2rem] p-6 transition-all hover:bg-slate-800 hover:-translate-y-1 hover:shadow-2xl hover:shadow-blue-500/10">
                        ...
                        <!-- Elite VVIP -->
                        <a href="<?php echo e(route('tips.vvip')); ?>" class="group relative bg-slate-800/50 border border-white/5 rounded-[2rem] p-6 transition-all hover:bg-slate-800 hover:-translate-y-1 hover:shadow-2xl hover:shadow-purple-500/10">
                        ...
                        <!-- Today's Tips -->
                        <a href="<?php echo e(route('predictions.tomorrow')); ?>" class="group relative bg-slate-800/50 border border-white/5 rounded-[2rem] p-6 transition-all hover:bg-slate-800 hover:-translate-y-1 hover:shadow-2xl hover:shadow-emerald-500/10">
                        ...
                        <!-- All Forecasts -->
                        <a href="<?php echo e(route('predictions')); ?>" class="group relative bg-slate-800/50 border border-white/5 rounded-[2rem] p-6 transition-all hover:bg-slate-800 hover:-translate-y-1 hover:shadow-2xl hover:shadow-slate-500/20">
                        ...
                        <!-- Upgrade Access -->
                        <a href="<?php echo e(route('pricing')); ?>" class="group relative bg-slate-800/50 border border-white/5 rounded-[2rem] p-6 transition-all hover:bg-slate-800 hover:-translate-y-1 hover:shadow-2xl hover:shadow-amber-500/20">
                        ...
                        <!-- Support Hub -->
                        <a href="<?php echo e(route('support')); ?>" class="group relative bg-slate-800/50 border border-white/5 rounded-[2rem] p-6 transition-all hover:bg-slate-800 hover:-translate-y-1 hover:shadow-2xl hover:shadow-indigo-500/10">
            ...
            <div class="bg-slate-900/50 backdrop-blur-xl rounded-[2.5rem] border border-white/5 overflow-hidden" data-aos="fade-up" data-aos-delay="300">
                ...
                <div class="p-8">
                    <div class="grid grid-cols-1 gap-4">
                        <a href="<?php echo e(route('predictions')); ?>" class="group flex items-center p-5 bg-slate-800/50 border border-white/5 rounded-3xl hover:bg-slate-800 transition-all hover:translate-x-1">
                        ...
                        <?php if($vipStatus['is_active']): ?>
                        <a href="<?php echo e(route('tips.vip')); ?>" class="group flex items-center p-5 bg-blue-500/5 border border-blue-500/10 rounded-3xl hover:bg-blue-500/10 transition-all hover:translate-x-1">
                        ...
                        <?php if($vvipStatus['is_active']): ?>
                        <a href="<?php echo e(route('tips.vvip')); ?>" class="group flex items-center p-5 bg-purple-500/5 border border-purple-500/10 rounded-3xl hover:bg-purple-500/10 transition-all hover:translate-x-1">
                        ...
                        <a href="<?php echo e(route('profile')); ?>" class="group flex items-center p-5 bg-slate-800/50 border border-white/5 rounded-3xl hover:bg-slate-800 transition-all hover:translate-x-1">
                ...
                <div class="p-8">
                    <div class="space-y-6">
                        <div class="bg-slate-950/50 p-5 rounded-2xl border border-white/5">
                            ...
                            <p class="font-bold text-white text-sm tracking-tight truncate"><?php echo e($user->email); ?></p>
                        </div>
                        <div class="bg-slate-950/50 p-5 rounded-2xl border border-white/5">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/simeonuba/Downloads/public_html (1)/resources/views/user/dashboard.blade.php ENDPATH**/ ?>